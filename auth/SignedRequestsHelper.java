...
public class SignedRequestsHelper {
	...
	private String endpoint = "webservices.amazon.ca"; // must be lowercase
	private String awsAccessKeyId = "AKIAJDLV5AJNXMOQYOZA";
	...
	public static void main(String args[]) throws InvalidKeyException, UnsupportedEncodingException, NoSuchAlgorithmException{
		SignedRequestsHelper sign = new SignedRequestsHelper();
		Map<String, String> paras = new TreeMap<String, String>();
		paras.put("Service", "AWSECommerceService");
		paras.put("Operation", "ItemLookup");
		paras.put("AssociateTag", "buysmart02a-20");
		//paras.put("ItemId","7619002");
		paras.put("ResponseGroup", "ItemAttributes,Offers,Large");
		paras.put("SearchIndex", "All");
		paras.put("ItemId", "885909950928");	
		paras.put("IdType","UPC");
		String url = sign.sign(paras);
