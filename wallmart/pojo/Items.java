...
public class Items
{
    ...
    {
        return "ClassPojo [ninetySevenCentShipping = "+ninetySevenCentShipping+", affiliateAddToCartUrl = "+affiliateAddToCartUrl+", customerRatingImage = "+customerRatingImage+", standardShipRate = "+standardShipRate+", thumbnailImage = "+thumbnailImage+", brandName = "+brandName+", giftOptions = "+giftOptions+", productTrackingUrl = "+productTrackingUrl+", stock = "+stock+", categoryNode = "+categoryNode+", msrp = "+msrp+", numReviews = "+numReviews+", freeShippingOver50Dollars = "+freeShippingOver50Dollars+", mediumImage = "+mediumImage+", name = "+name+", shipToStore = "+shipToStore+", longDescription = "+longDescription+", addToCartUrl = "+addToCartUrl+", bundle = "+bundle+", imageEntities = "+imageEntities+", marketplace = "+marketplace+", customerRating = "+customerRating+", maxItemsInOrder = "+maxItemsInOrder+", largeImage = "+largeImage+", parentItemId = "+parentItemId+", clearance = "+clearance+", itemId = "+itemId+", upc = "+upc+", size = "+size+", categoryPath = "+categoryPath+", availableOnline = "+availableOnline+", shortDescription = "+shortDescription+", productUrl = "+productUrl+", salePrice = "+salePrice+", freeShipToStore = "+freeShipToStore+", preOrder = "+preOrder+", modelNumber = "+modelNumber+"]";
    }
}
